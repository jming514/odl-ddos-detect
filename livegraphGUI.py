...
QUIT_BUTTON = tk.Button(root, text = "Quit", command = root.quit, anchor = 'w',
                    width = 20, height = 2,bg = "#2FB19F", activebackground = "#00FF00")
QUIT_BUTTON_WINDOW = canvas.create_window(65, 137, anchor='nw', window=QUIT_BUTTON)   
    
main2_button = tk.Button(root, text = "Show Live Graph", command = LiveGraph, anchor = 'w',
                    width = 20,height = 2,bg = "#2FB19F", activebackground = "#00FF00")
main2_button_window = canvas.create_window(65,90, anchor='nw', window=main2_button)
root.mainloop()